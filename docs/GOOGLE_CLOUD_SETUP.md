...
run. See [AGENT_RULES §8](../AGENT_RULES.md) and [agent_tools/INDEX.md](../agent_tools/INDEX.md).
...
looking. It is a hard failure rather than a warning on purpose — [AGENT_RULES §2.1](../AGENT_RULES.md)
