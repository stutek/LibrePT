...
export const sl = {
  ...
  modality_option_cardio: "Kardio — čas / razdalja / kalorije / vati / tempo / srčni utrip",
  modality_option_stretch: "Raztezanje — čas zadrževanja",
  modality_option_balance: "Ravnotežje — čas zadrževanja",
  modality_option_agility: "Agilnost — čas / razdalja / ponovitve",
  metric_label: "Merilo",
  ...
  adjust_action_swap: "Zamenjaj vajo (lažja ali težja različica)",
  adjust_action_dismiss: "Samo zapri opozorilo (brez sprememb)",
  adjust_target_weight: "Ciljna teža (kg)",
  adjust_target_reps: "Ciljne ponovitve",
  adjust_target_sets: "Ciljno število serij",
