...
export function bugIssueUrl({ repoUrl, title, whatHappened, diagnostics }) {
  ...
  const body = [
    ...
    "",
    "     THIS PAGE IS PUBLIC. Crop or blur anything that identifies a client — names, contact",
    "     details, notes — before you attach it. Their data is yours to protect, and a bug is",
