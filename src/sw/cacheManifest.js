...
self.swCacheManifest = (() => {
  ...
  const ASSETS = [
    ...
    "./modules/clipboard/planColumns.css",
    ...
    "./modules/demo/demoPace.js",
    "./modules/demo/demoTourPlayer.js",
    "./modules/demo/gymFloorTour.js",
    "./modules/demo/storyTour.js",
    "./modules/demo/demoNarratorCard.js",
    "./modules/demo/storySignupFile.js",
    "./modules/demo/walkthroughOverlay.js",
    "./modules/demo/walkthrough.css",
    "./modules/demo/demoNarratorCard.css",
    ...
    "./modules/sessionList/sessionFilterBar.css",
    ...
    "./domain/intakeSender.js",
    "./domain/planDuration.js",
    "./domain/participantBinding.js",
    "./domain/planCopy.js",
    "./domain/clientSessionNeighbours.js",
    "./domain/inviteExpiry.js",
    "./domain/sessionChangeNotice.js",
    "./domain/walkthrough.js",
    "./domain/notificationItems.js",
    "./domain/catalogMatch.js",
    "./domain/programImport.js",
    "./domain/walkthroughReadiness.js",
    "./domain/overlapLanes.js",
    "./domain/timeRange.js",
    "./domain/scheduleConflicts.js",
    "./domain/sessionRecord.js",
    "./domain/sessionFilters.js",
    // Common modules & helpers
    "./modules/common/utils.js",
    "./modules/common/dom.js",
    "./modules/common/formDraft.js",
    "./modules/common/trainerFormDraft.js",
    "./data/trainerDrafts.js",
    "./controllers/formRecoveryController.js",
    "./controllers/formRecoveryPolicies.js",
    ...
    "./modules/clipboard/deckScrollFocus.js",
    ...
    "./modules/session/sessionRepeatControls.js",
    ...
    "./modules/sessionList/sessionFilterBar.js",
