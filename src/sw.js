...
const ASSETS = [
  ...
  "./modules/session/clipboardEditor.js",
  "./modules/session/daySelector.js",
  "./modules/session/editSessionControl.js",
  "./modules/session/editSessionView.js",
  "./modules/session/exerciseAndRestTimer.js",
  "./modules/session/exerciseCard.js",
  "./modules/session/exerciseDeck.js",
  "./modules/session/sessionBar.js",
  "./modules/session/sessionCard.js",
  "./modules/session/sessionList.js",
  "./modules/session/sessionTitleBar.js",
  "./modules/session/sessionsView.js",
  "./modules/session/supersetCard.js",
  // Domain controllers
