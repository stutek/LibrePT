...
| [src/helper/sessionCache.js](file:///home/simon/Projects/LibrePT/src/helper/sessionCache.js) | `helper` | Handles JSON serialization and recovery of active session state in `localStorage`. |
